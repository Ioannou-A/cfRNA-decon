...
L_topNo_list = [500, 1000, 1500]

bulk_RNAseq_file = 'TOO-Decon/20250616_All-Tissues-NoDup_Uniform_Simulated_v2_Counts.txt'
output_folder = 'TOO-Decon/ReDeconv-TOO_v2-Uniform-NoDup-2/'

meta_files = sorted(glob.glob('TOO-Matrix/TOO-Matrices_ReDeconv/*Metadata.txt'))
exp_files = sorted(glob.glob('TOO-Matrix/TOO-Matrices_ReDeconv/*_ReDeconv_Renamed.txt'))
