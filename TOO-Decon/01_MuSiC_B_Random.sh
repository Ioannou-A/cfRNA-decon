...
#$ -N July23_MuSiC_R     # Name the job nuSVU-Decon
#$ -m ae
#$ -M s2556897@ed.ac.uk
...
MIXTURE="${BASE_DIR}/20250616_All-Tissues-NoDup_Random_Simulated_v2_Counts.txt"
...
for ref in "${REF_DIR}"/*LessTissueV2*-withGTFNames.tsv; do
    ...
    OUTPUT_FILE="${RESULTS_DIR}/${REF_NAME}_Random_Simulated_v2_MuSiC_proportions.txt"
