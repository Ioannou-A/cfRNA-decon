...
MIXTURE_FILES=(
  "${MIXTURE_DIR}/20250616_All-Tissues-NoDup_Random_40_percent_removed_CPM.txt"
  "${MIXTURE_DIR}/20250616_All-Tissues-NoDup_Random_20_percent_removed_CPM.txt"
  "${MIXTURE_DIR}/20250616_All-Tissues-NoDup_Random_60_percent_removed_CPM.txt"
  "${MIXTURE_DIR}/20250616_All-Tissues-NoDup_Random_80_percent_removed_CPM.txt"
  "${MIXTURE_DIR}/20250616_All-Tissues-NoDup_Random_100_percent_removed_CPM.txt"
)
...
for REF in "${REF_FILES[@]}"; do
  for MIX in "${MIXTURE_FILES[@]}"; do
    ...
    # Run the R script
    Rscript 01_MuSiC_A_Run.R "$REF" "$MIX" "$OUTPUT_FILE"
  done
done
