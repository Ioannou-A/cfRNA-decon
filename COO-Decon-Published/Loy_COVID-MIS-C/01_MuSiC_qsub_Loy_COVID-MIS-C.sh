...
# Mixture files
MIXTURE="COO-Decon-Published/Loy_COVID-MIS-C/GSE225221_cfrna_counts_CPM_GeneNames.txt"

# Output directories
OUTDIR="COO-Decon-Published/Loy_COVID-MIS-C/Decon-COO-Results_Loy_COVID-MIS-C"

mkdir -p "$OUTDIR"

# Run mixture
echo "Running MuSiC on Loy mixture..."
OUTPUT="${OUTDIR}/TSP-HBA_Inner_100each_seed42_Loy_COVID-MIS-C_MuSiC.txt"
Rscript COO-Decon-Published/Loy_COVID-MIS-C/01_run_MuSiC-2.R "$REF" "$META" "$MIXTURE" "$OUTPUT"
