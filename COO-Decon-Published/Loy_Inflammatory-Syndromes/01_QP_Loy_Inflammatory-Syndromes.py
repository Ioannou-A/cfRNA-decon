...
data_path_Loy_Inflammatory="COO-Decon-Published/Loy_Inflammatory-Syndromes/GSE255555_pedInflam_filtered_counts_CPM_GeneNames.txt"
output_dir_Loy_Inflammatory="COO-Decon-Published/Loy_Inflammatory-Syndromes/Decon-COO-Results_Loy_Inflammatory-Syndromes"
...
print(f"Running QP for {basis_path} -> Output: {output_dir_Loy_Inflammatory}")
