...
print(f"Running QP for {data_path_healthy} -> Output: {output_dir_healthy}")
...
print(f"Running QP for {data_path_nafld} -> Output: {output_dir_nafld}")
...
print(f"Running QP for {data_path_nash} -> Output: {output_dir_nash}")
