...
output_dir="COO-Decon-Published/Chalasani_Fatty-Liver/BayesPrism-Deconvolutions"
mkdir -p "$output_dir"
...
for bulk in "${bulk_files[@]}"; do
  for sc in "${sc_refs[@]}"; do
    ...
    Rscript COO-Decon-Published/Chalasani_Fatty-Liver/01_BayesPrism_A_Run.R "$bulk" "$sc" "$output_file"
