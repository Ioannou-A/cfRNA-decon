...
RESULTS_DIR="${BASE_DIR}/Loy_COVID-MIS-C/Decon-Results_Loy_COVID-MIS-C"
MIXTURE="${BASE_DIR}/Loy_COVID-MIS-C/GSE225221_cfrna_counts_CPM_GeneNames.txt"
...
# Run the R script
Rscript TOO-Decon-Published/Loy_COVID-MIS-C/01_MuSiC_A_Run.R "$ref" "$MIXTURE" "$OUTPUT_FILE"
