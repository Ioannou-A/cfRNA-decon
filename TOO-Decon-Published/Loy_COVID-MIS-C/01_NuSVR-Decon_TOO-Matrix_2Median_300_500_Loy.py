...
data = "TOO-Decon-Published/Loy_COVID-MIS-C/GSE225221_cfrna_counts_CPM_GeneNames.txt"
...
output = "TOO-Decon-Published/Loy_COVID-MIS-C/Decon-Results_Loy_COVID-MIS-C"
