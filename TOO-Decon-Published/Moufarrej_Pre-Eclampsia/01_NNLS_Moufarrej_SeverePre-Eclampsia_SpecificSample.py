...
# Define paths
data_path = "TOO-Decon-Published/Moufarrej_Pre-Eclampsia/GSE192902_SeverePre-eclampsia_preQC_filtered_counts_UniquePatient_SpecificSample.txt"
...
output_dir_name = "Decon-Results_Moufarrej_SeverePre-Eclampsia_SpecificSample"
