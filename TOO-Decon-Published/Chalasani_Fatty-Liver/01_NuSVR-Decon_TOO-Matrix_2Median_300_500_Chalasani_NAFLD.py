...
data = "TOO-Decon-Published/Chalasani_Fatty-Liver/All-NAFLD_Counts_v46_Clean_UniquePatients_CPM.txt"
...
output = "TOO-Decon-Published/Chalasani_Fatty-Liver/Decon-Results_Chalasani_NAFLD"
