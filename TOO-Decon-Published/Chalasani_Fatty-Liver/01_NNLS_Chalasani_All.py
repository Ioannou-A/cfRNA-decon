...
# Define paths
data_path = "TOO-Decon-Published/Chalasani_Fatty-Liver/All-NAFLD_Counts_v46_Clean_UniquePatients_CPM.txt"
...
output_dir_name = "Decon-Results_Chalasani_NAFLD"
...
# Define paths
data_path = "TOO-Decon-Published/Chalasani_Fatty-Liver/All-NASH_Counts_v46_Clean_UniquePatients_CPM.txt"
base_output_dir = os.getcwd()
...
# Create the directory
output_dir_name = "Decon-Results_Chalasani_NASH"
output_dir = os.path.join(base_output_dir, output_dir_name)
os.makedirs(output_dir, exist_ok=True)
...
# Define paths
data_path = "TOO-Decon-Published/Chalasani_Fatty-Liver/All-Healthy_Counts_v46_Clean_UniquePatients_CPM.txt"
base_output_dir = os.getcwd()
...
# Create the directory
output_dir_name = "Decon-Results_Chalasani_Healthy"
output_dir = os.path.join(base_output_dir, output_dir_name)
os.makedirs(output_dir, exist_ok=True)
