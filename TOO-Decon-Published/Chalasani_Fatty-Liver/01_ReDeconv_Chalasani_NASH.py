...
bulk_RNAseq_file = 'TOO-Decon-Published/Chalasani_Fatty-Liver/All-Healthy_Counts_v46_Clean_UniquePatients_CPM.txt'
output_folder = 'TOO-Decon-Published/Chalasani_Fatty-Liver/Decon-Results_Chalasani_Healthy/'
