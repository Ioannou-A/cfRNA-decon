...
bulk_file=(
  "TOO-Decon-Published/Loy_Inflammatory-Syndromes/GSE255555_pedInflam_filtered_counts_CPM_GeneNames.txt"
)
...
Rscript TOO-Decon-Published/Loy_Inflammatory-Syndromes/01_BayesPrism_A_Run.R "$bulk_file" "$sc_ref" "$output_file"
