...
# Define paths
data_path = "TOO-Decon-Published/Loy_Inflammatory-Syndromes/GSE255555_pedInflam_filtered_counts_CPM_GeneNames.txt"
...
output_dir_name = "Decon-Results_Loy_Inflammatory-Syndromes"
