...
bulk_file=(
  "TOO-Decon-Published/Toden_AD/All-AD_Counts_v46_Clean_UniquePatients_CPM.txt"
)
...
Rscript TOO-Decon-Published/Toden_AD/01_BayesPrism_A_Run.R "$bulk_file" "$sc_ref" "$output_file"
