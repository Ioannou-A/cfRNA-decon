...
# Define paths
data_path = "TOO-Decon-Published/Toden_AD/All-AD_Counts_v46_Clean_UniquePatients_CPM.txt"
...
output_dir_name = "Decon-Results_Toden_AD"
...
# Define paths
data_path = "TOO-Decon-Published/Toden_AD/All-NCI_Counts_v46_Clean_UniquePatients_CPM.txt"
base_output_dir = os.getcwd()
...
# Create the directory
output_dir_name = "Decon-Results_Toden_NCI"
output_dir = os.path.join(base_output_dir, output_dir_name)
os.makedirs(output_dir, exist_ok=True)
