## Script to merge the two datasets (Tabula sapiesn scRNA and Darmanis Brain scRNA data) using an approach to only keep the shared genes
...
merged_adata.write_h5ad('COO-Matrix/DarmanisData/TSP-BDa-merged-Inner.h5ad')