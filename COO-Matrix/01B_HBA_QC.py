...
## Script to filter and QC a subsampled portion of HBA data the same way as was done for the TSP V1 matrix

# Read the data and sample
sampled_HBA = sc.read_h5ad('COO-Matrix/HumanBrainAtlas-snRNA-V1/HBA-subsampled_200k.h5ad')
...
sampled_HBA.write_h5ad('COO-Matrix/HumanBrainAtlas-snRNA-V1/HBA-subsampled_processed.h5ad')
