## Script to merge the two datasets (Tabula sapiesn scRNA and Human Brain Atlas snRNA) using an approach to keep all genes
import scanpy as sc
import numpy as np
...
merged_adata.write_h5ad('COO-Matrix/HumanBrainAtlas-snRNA-V1/TSP-HBA-QC-merged.h5ad')
