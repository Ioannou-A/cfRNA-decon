...
sample 100 or 2100 of each cell type to be used as a reference sample for MuSiC deconvolution 
from the TSP-HBA matrix.
This also saves the metadata (donor information for music decon)
...
basePath = "COO-Matrix/HumanBrainAtlas-snRNA-V1/"
adataName = "TSP-HBA-QC-Inner.h5ad"
cellAnnotCol = "cell_ontology_class"
fend = "TSP-HBA_Inner_100each.txt"
clusters_path = "COO-Matrix/TSP-HBA_Inner_All-Compartments_clusters.csv"
