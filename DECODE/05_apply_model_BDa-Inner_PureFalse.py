...
# Settings
# -------------------------
tissue_name = "TSP-BDa_Inner_s600_a50_ab1_NewTrain_NewSampling_Dirichtler_81celltypes_81.5kpseudo"

external_pseudobulk_txt = "Random_v2C_All-Counts.txt"
output_csv = "TSP-BDa_Inner_Random_v2C_DECODE-PureFalse_predictions_Stage3Val.txt"
#output_csv = "TSP-BDa_Inner_Random_v2C_DECODE-PureTrue_predictions.txt"
...
training_h5ad = "/exports/eddie/scratch/s2556897/DECODE/test-data/TSP-BDa-merged-Inner_matched_DECODE_1500each.h5ad"
...
#model_path = f"save_models/{num_feat}/{tissue_name}_train73500_DANNpatience20.pt"
