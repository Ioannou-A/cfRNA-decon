...
# 5,000 of the 35,000 tissue mixtures for validation.
# Values evaluated in the training-size analysis:
# 5,000, 10,000, 15,000, 20,000, 25,000, and 30,000.
subset_size = 5000

# DANN early-stopping patience.
# Values evaluated for TOO:
# 3, 5, 10, and 15
dann_patience = 10
...
pkl_path = f"data/{tissue_name}/{tissue_name}30cell.pkl"
