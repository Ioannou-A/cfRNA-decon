...
bulk_files=(
  ...
  "TOO-Decon-Degradation/Data/20250616_All-Tissues-NoDup_Uniform_Degradation_top_10_percent_removed.txt"
  "TOO-Decon-Degradation/Data/20250616_All-Tissues-NoDup_Uniform_Degradation_top_20_percent_removed.txt"
  "TOO-Decon-Degradation/Data/20250616_All-Tissues-NoDup_Uniform_Degradation_top_30_percent_removed.txt"
  "TOO-Decon-Degradation/Data/20250616_All-Tissues-NoDup_Uniform_Degradation_top_40_percent_removed.txt"
)
...
output_dir="TOO-Decon-Degradation/BayesPrism-Deconvolutions"
mkdir -p "$output_dir"
...
for bulk in "${bulk_files[@]}"; do
  for sc in "${sc_refs[@]}"; do
    ...
    Rscript TOO-Decon-Degradation/01_BayesPrism_A_Run.R "$bulk" "$sc" "$output_file"
  done
done
