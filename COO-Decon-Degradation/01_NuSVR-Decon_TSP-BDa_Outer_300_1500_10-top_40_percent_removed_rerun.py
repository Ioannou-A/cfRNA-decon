...
if __name__ == "__main__":
    ...
    # Only 1 missing TOP40 sample
    sample_indices = [
        254   # TSP25 rep3 seed11 20_400
    ]

    # Full hyperparameter grid (5×6 = 30)
    ...
    # Correct TOP 40% paths
    scaled_data_path = "COO-Decon-Degradation/CIBERSORTx-Matrix_TSP-BDa_Outer_300_1500_10/Random_v2C_top_40_percent_removed_CIBERSORTx-Matrix_TSP-BDa_Outer_300_1500_10_scaled_mixture.txt"
    scaled_basis_path = "COO-Decon-Degradation/CIBERSORTx-Matrix_TSP-BDa_Outer_300_1500_10/Random_v2C_top_40_percent_removed_CIBERSORTx-Matrix_TSP-BDa_Outer_300_1500_10_scaled_basis.txt"
    output_dir = "COO-Decon-Degradation/Decon-COO-Results_Degradation_v4_top_40_percent_removed_nuSVR/"
    ...
    outfile = f"nuSVR_Rerun_DegradationTop40_{sample_clean}_C{c_val}_nu{nu_val}.txt"
