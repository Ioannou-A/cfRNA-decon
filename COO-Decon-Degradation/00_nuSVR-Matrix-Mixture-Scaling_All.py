...
# Main run
data_paths = [ 
    "COO-Decon-Degradation/Data/Random_v2C_top_10_percent_removed.txt",
    "COO-Decon-Degradation/Data/Random_v2C_top_20_percent_removed.txt",
    "COO-Decon-Degradation/Data/Random_v2C_top_30_percent_removed.txt",
    "COO-Decon-Degradation/Data/Random_v2C_top_40_percent_removed.txt"
    ]

basis_paths = [
    "COO-Decon-Degradation/CIBERSORTx-Matrix_TSP-BDa_Outer_300_1500_10/CIBERSORTx_TSP-BDa_Outer_25each_inferred_phenoclasses.CIBERSORTx_TSP-BDa_Outer_25each_inferred_refsample.bm.K999.txt"
]
