...
OUTPUT_DIR = os.path.join(BASE_DIR, "ReDeconv-Deconvolution-Random_v2C_Degradation")
...
mixture_files = sorted(glob.glob(os.path.join(MIXTURE_DIR, "Random_v2C_top_*.txt")))
