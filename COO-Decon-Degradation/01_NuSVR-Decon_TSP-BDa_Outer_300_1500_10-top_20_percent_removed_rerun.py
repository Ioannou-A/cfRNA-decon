...
if __name__ == "__main__":
    ...
    # Missing samples (TOP 20% RUN)
    sample_indices = [
        335,  # TSP21 rep3 seed6 40_800
        443,  # TSP21 rep4 seed6 10_200
        29    # TSP25 rep4 seed9 20_400
    ]
    ...
    # Determine task → sample + hyperparam pair
    ...
    # TOP 20% paths
    scaled_data_path = "COO-Decon-Degradation/CIBERSORTx-Matrix_TSP-BDa_Outer_300_1500_10/Random_v2C_top_20_percent_removed_CIBERSORTx-Matrix_TSP-BDa_Outer_300_1500_10_scaled_mixture.txt"
    scaled_basis_path = "COO-Decon-Degradation/CIBERSORTx-Matrix_TSP-BDa_Outer_300_1500_10/Random_v2C_top_20_percent_removed_CIBERSORTx-Matrix_TSP-BDa_Outer_300_1500_10_scaled_basis.txt"
    output_dir = "COO-Decon-Degradation/Decon-COO-Results_Degradation_v4_top_20_percent_removed_nuSVR/"
    ...
    outfile = f"nuSVR_Rerun_DegradationTop20_{sample_clean}_C{c_val}_nu{nu_val}.txt"
