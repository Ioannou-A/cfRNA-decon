...
TASKID=$SGE_TASK_ID
basis_path="CIBERSORTx-Matrix_TSP-BDa_Inner_3000_5000_10/CIBERSORTx_TSP-BDa_Inner_25each_inferred_phenoclasses.CIBERSORTx_TSP-BDa_Inner_25each_inferred_refsample.bm.K999.txt"
