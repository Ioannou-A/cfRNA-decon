...
if __name__ == "__main__":
    ...
    scaled_basis_path = "COO-Decon-Pseudobulks/CIBERSORTx-Matrix_TSP-BDa_Inner_1000_3000_10/Random_v2C_All-Counts_CIBERSORTx-Matrix_TSP-BDa_Inner_1000_3000_10_scaled_basis.txt"
    scaled_data_path = "COO-Decon-Pseudobulks/CIBERSORTx-Matrix_TSP-BDa_Inner_1000_3000_10/Random_v2C_All-Counts_CIBERSORTx-Matrix_TSP-BDa_Inner_1000_3000_10_scaled_mixture.txt"
    output_dir = "COO-Decon-Pseudobulks/CIBERSORTx-Matrix_TSP-BDa_Inner_1000_3000_10/"

    run_sample_batch_parallel(scaled_data_path, scaled_basis_path, output_dir, start_idx, end_idx, n_jobs=6)