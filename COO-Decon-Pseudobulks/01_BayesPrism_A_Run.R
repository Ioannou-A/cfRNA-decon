...
# Remove the first row of the input matrix as it contains the cell barcodes
single_cell_object <- single_cell_object[-1, ]
...
processed_vector <- sub("\\.\\d+$", "", row_names_vector)
