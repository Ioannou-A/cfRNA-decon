...
# Base directories
BASE_DIR = "COO-Decon-Undetected"
MIXTURE_DIR = os.path.join(BASE_DIR, "Data")
OUTPUT_DIR = os.path.join(BASE_DIR, "ReDeconv-Deconvolution-Random_v2C_Undetected")

os.makedirs(OUTPUT_DIR, exist_ok=True)

# Reference files
meta_file = "COO-Matrix/TSP-HBA_Inner_100each_seed42-ReDeconv_metadata.txt"
...
mixture_files = sorted(glob.glob(os.path.join(MIXTURE_DIR, "Random_v2C_NotDetected_*_percent_removed_CPM.txt")))
...
for bulk_RNAseq_file in mixture_files:
    ...
    for L_topNo in L_topNo_list:
        ...
        fn_percentage_save = os.path.join(OUTPUT_DIR, f"{tag}_ReDeconv_results.txt")
