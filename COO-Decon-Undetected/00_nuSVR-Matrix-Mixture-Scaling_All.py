...
# Main run
data_paths = [
    "COO-Decon-Undetected/Data/Random_v2C_NotDetected_20_percent_removed_CPM.txt",
    "COO-Decon-Undetected/Data/Random_v2C_NotDetected_40_percent_removed_CPM.txt",
    "COO-Decon-Undetected/Data/Random_v2C_NotDetected_60_percent_removed_CPM.txt",
    "COO-Decon-Undetected/Data/Random_v2C_NotDetected_80_percent_removed_CPM.txt",
    "COO-Decon-Undetected/Data/Random_v2C_NotDetected_100_percent_removed_CPM.txt",
]

basis_paths = [
    "COO-Decon-Undetected/CIBERSORTx-Matrix_TSP-BDa_Outer_300_1500_10/CIBERSORTx_TSP-BDa_Outer_25each_inferred_phenoclasses.CIBERSORTx_TSP-BDa_Outer_25each_inferred_refsample.bm.K999.txt"
]
