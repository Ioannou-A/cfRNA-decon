...
#$ -t 1-9                 # 9 tasks to cover 90 samples (10 per task)
...
RAW_DIR="${BASE_DIR}/Chalasani_Liver/All-Healthy-Raw-Fastq"
TRIMMED_DIR="${BASE_DIR}/Chalasani_Liver/All-Healthy-Trimmed"
ALIGNED_DIR="${BASE_DIR}/Chalasani_Liver/All-Healthy-Aligned"
SAMPLE_LIST="${BASE_DIR}/Chalasani_Liver/All_Healthy_sra_ids.txt"
