...
#$ -t 1-13                 # 13 tasks, each handling 14 samples
#$ -l h_vmem=12G           # 12 GB memory per core
#$ -pe sharedmem 8         # 8 cores for STAR
#$ -cwd
#$ -l h_rt=24:00:00        # Max runtime 24 hours per sample
#$ -N NAFLD_Align
#$ -m ae
#$ -M s2556897@ed.ac.uk
...
RAW_DIR="${BASE_DIR}/Chalasani_Liver/All-NAFLD-Raw-Fastq"
TRIMMED_DIR="${BASE_DIR}/Chalasani_Liver/All-NAFLD-Trimmed"
ALIGNED_DIR="${BASE_DIR}/Chalasani_Liver/All-NAFLD-Aligned"
SAMPLE_LIST="${BASE_DIR}/Chalasani_Liver/All_NAFLD_sra_ids.txt"
