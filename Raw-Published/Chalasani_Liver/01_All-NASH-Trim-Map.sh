...
#$ -t 1-27                 # 27 tasks to cover 664 samples (25 per task, last task processes 14)
#$ -l h_vmem=15G           # 15 GB memory per core
#$ -pe sharedmem 4         # 8 cores for STAR
#$ -cwd
#$ -l h_rt=47:00:00        # Max runtime 24 hours per sample
#$ -N NASH_Align
#$ -m ae
#$ -M s2556897@ed.ac.uk
...
RAW_DIR="${BASE_DIR}/Chalasani_Liver/All-NASH-Raw-Fastq"
TRIMMED_DIR="${BASE_DIR}/Chalasani_Liver/All-NASH-Trimmed"
ALIGNED_DIR="${BASE_DIR}/Chalasani_Liver/All-NASH-Aligned"
SAMPLE_LIST="${BASE_DIR}/Chalasani_Liver/All_NASH_sra_ids.txt"
