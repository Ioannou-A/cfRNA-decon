...
if __name__ == "__main__":
    ...
    sample_indices = [
        578,   # TSP21 rep2 seed4 30_600
        725,   # TSP21 rep3 seed13 20_400
        334,   # TSP21 rep3 seed6 50_1000
        48,    # TSP21 rep4 seed13 50_1000
        451,   # TSP27 rep1 seed11 10_200
        620,   # TSP27 rep1 seed12 10_200
        34,    # TSP27 rep4 seed11 20_400
    ...
    scaled_data_path = "COO-Decon-Noise/CIBERSORTx-Matrix_TSP-BDa_Outer_300_1500_10/Random_v2C-Noisy_phi3.0e+01_All-Counts_CIBERSORTx-Matrix_TSP-BDa_Outer_300_1500_10_scaled_mixture.txt"
    scaled_basis_path = "COO-Decon-Noise/CIBERSORTx-Matrix_TSP-BDa_Outer_300_1500_10/Random_v2C-Noisy_phi3.0e+01_All-Counts_CIBERSORTx-Matrix_TSP-BDa_Outer_300_1500_10_scaled_basis.txt"
    output_dir = "COO-Decon-Noise/Decon-COO-Results_v3_Noise_phi30_nuSVR/"
    ...
    outfile = f"nuSVR_Rerun_NoisePhi30_{sample_clean}_C{c_val}_nu{nu_val}.txt"
