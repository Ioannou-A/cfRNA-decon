...
if __name__ == "__main__":
    ...
    # 16 rerun sample indices
    sample_indices = [
        379, 578, 787, 471, 753, 334, 48, 365, 401,
        774, 395, 246, 218, 575, 23, 3
    ]

    # 30 hyperparameter pairs
    ...
    # φ = 5.0 file paths
    scaled_data_path = "COO-Decon-Noise/CIBERSORTx-Matrix_TSP-BDa_Outer_300_1500_10/Random_v2C-Noisy_phi5.0e+00_All-Counts_CIBERSORTx-Matrix_TSP-BDa_Outer_300_1500_10_scaled_mixture.txt"
    scaled_basis_path = "COO-Decon-Noise/CIBERSORTx-Matrix_TSP-BDa_Outer_300_1500_10/Random_v2C-Noisy_phi5.0e+00_All-Counts_CIBERSORTx-Matrix_TSP-BDa_Outer_300_1500_10_scaled_basis.txt"
    output_dir = "COO-Decon-Noise/Decon-COO-Results_v3_Noise_phi5_nuSVR/"
    ...
    outfile = f"nuSVR_Rerun_NoisePhi5_{sample_clean}_C{c_val}_nu{nu_val}.txt"
